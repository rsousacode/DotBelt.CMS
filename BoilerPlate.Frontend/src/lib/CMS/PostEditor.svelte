  ...
  <div class="row">
    <div class="col">
      <div class="editor-container">
        <div>
          <span>URL: </span>
          <input class="classy-input permalink-input" onchange={handlePermalinkChanged} type="text" style="color: #494949" placeholder="Permalink here" bind:value={post.urlName}>
        </div>
        <div>
          <input  class="classy-input" type="text" style="color: #494949" placeholder="Write your title here" bind:value={post.title}>
    ...
    <div class="col-sm-2">
      ...
      <button class="btn btn-primary" type="button" onclick={onSwitchMode}>{currentMode === 'editor' ? 'Code Editor' : 'Visual Editor'}</button>
