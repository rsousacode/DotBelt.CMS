...
!(function (t, e) {
  ...
  class xt extends W {
    ...
    _maybeEnableCycle() {
      this._config.ride &&
        (this._isSliding ? N.one(this._element, ut, () => this.cycle()) : this.cycle());
    }
    to(t) {
  ...
  function ge(t) {
    return (
      'undefined' != typeof ShadowRoot && (t instanceof fe(t).ShadowRoot || t instanceof ShadowRoot)
    );
  }
  const _e = {
    name: 'applyStyles',
  ...
  class Ui extends H {
    ...
    dispose() {
      this._isAppended &&
        (N.off(this._element, Qi), this._element.remove(), (this._isAppended = !1));
    }
    _getElement() {
      if (!this._element) {
  ...
  class cs extends W {
    ...
    show() {
      ...
      if (
        (this._element.ownerDocument.documentElement.contains(this.tip) ||
          (n.append(i), N.trigger(this._element, this.constructor.eventName('inserted'))),
    ...
    hide() {
      if (
        this._isShown() &&
        !N.trigger(this._element, this.constructor.eventName('hide')).defaultPrevented
      ) {
        if (
          (this._getTipElement().classList.remove(es), 'ontouchstart' in document.documentElement)
        )
          for (const t of [].concat(...document.body.children)) N.off(t, 'mouseover', h);
        ...
        if ('click' === e)
          ...
          N.on(this._element, t, this._config.selector, (t) => {
            ...
            N.on(this._element, i, this._config.selector, (t) => {
              const e = this._initializeOnDelegatedTarget(t);
              (e._activeTrigger['focusout' === t.type ? os : ss] = e._element.contains(
                t.relatedTarget,
              )),
                e._leave();
            });
