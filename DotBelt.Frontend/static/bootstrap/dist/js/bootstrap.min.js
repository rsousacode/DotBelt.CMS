...
!(function (t, e) {
  ...
  class Ot extends W {
    ...
    _maybeEnableCycle() {
      this._config.ride &&
        (this._isSliding ? j.one(this._element, ft, () => this.cycle()) : this.cycle());
    }
    to(t) {
  ...
  class we extends q {
    ...
    dispose() {
      this._isAppended &&
        (j.off(this._element, be), this._element.remove(), (this._isAppended = !1));
    }
    _getElement() {
      if (!this._element) {
  ...
  class Ni extends W {
    ...
    show() {
      ...
      if (
        (this._element.ownerDocument.documentElement.contains(this.tip) ||
          (s.append(i), j.trigger(this._element, this.constructor.eventName('inserted'))),
    ...
    hide() {
      if (
        this._isShown() &&
        !j.trigger(this._element, this.constructor.eventName('hide')).defaultPrevented
      ) {
        if (
          (this._getTipElement().classList.remove(Ti), 'ontouchstart' in document.documentElement)
        )
          for (const t of [].concat(...document.body.children)) j.off(t, 'mouseover', _);
        ...
        if ('click' === e)
          ...
          j.on(this._element, t, this._config.selector, (t) => {
            ...
            j.on(this._element, i, this._config.selector, (t) => {
              const e = this._initializeOnDelegatedTarget(t);
              (e._activeTrigger['focusout' === t.type ? Li : Si] = e._element.contains(
                t.relatedTarget,
              )),
                e._leave();
            });
